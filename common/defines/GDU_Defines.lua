...
NDefines.NCountry.BASE_MOBILIZATION_SPEED = 0.4
...
NDefines.NMilitary.LAND_SPEED_MODIFIER = 0.017                   -- basic speed control
...
NDefines.NAir.AIR_WING_COUNTRY_XP_FROM_TRAINING_FACTOR = 0.4 					-- air xp gain from training doubled from vanilla, since planes cost more so you get a decent amount of air XP from training air wings --Factor on country Air XP gained from wing training
...
NDefines.NAir.DISRUPTION_FACTOR_CARRIER = 17.0							-- multiplier on disruption damage to scale its effects on carrier vs carrier planes
