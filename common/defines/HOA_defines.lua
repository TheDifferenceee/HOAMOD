...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.18, 0.175, 0.145, 0.04, 0.0 } --{2.0, 0.5, 0.2, 0.1, 0.0}
...
NDefines.NMilitary.DIG_IN_FACTOR = 0.015                           -- bonus factor for each dug-in level --0.02 yani vanilla degeri sonradan bakabilirim         entrench 2x              
...
NDefines.NAir.AIR_WING_ATTACK_LOGISTICS_TRUCK_DAMAGE_FACTOR = 0.17 --0.27
...
NDefines.NAir.AIR_WING_ATTACK_LOGISTICS_RAILWAY_DAMAGE_SPILL_FACTOR = 0.002 -- Portion of train damage to additionally deal to railways --0.006
