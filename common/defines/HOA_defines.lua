...
NDefines.NMilitary.DIVISION_SIZE_FOR_XP = 16 -- vanilla 8
NDefines.NMilitary.BASE_LEADER_TRAIT_GAIN_XP = 0.15 -- vanilla 0.45
NDefines.NMilitary.ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.5 -- vanilla 0.1
