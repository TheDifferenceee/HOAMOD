...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.4, 0.25, 0.1, 0.03, 0.0 } --{2.0, 0.5, 0.2, 0.1, 0.0}
...
NDefines.NMilitary.LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.03 --vanilla 0.053      -- global damage modifier
