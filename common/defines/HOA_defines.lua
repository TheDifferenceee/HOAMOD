...
NDefines.NCountry.SCORCHED_EARTH_STATE_COST = 25					-- pp cost to scorch a state  --5
...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 1.0              -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively) --10.0 yani vanilla deger      
