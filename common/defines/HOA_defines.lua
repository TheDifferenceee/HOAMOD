...
NDefines.NAir.NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 0.001	
...
NDefines.NNavy.MAX_ANTI_AIR_REDUCTION_EFFECT_ON_INCOMING_AIR_DAMAGE = 0.875    -- damage reduction for incoming air attacks is clamped to this value at maximum. --0.75 yani vanilla deger       
