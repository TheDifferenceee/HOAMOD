...
NDefines.NMilitary.LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 1 -- how many CAS/TAC can enter a combat depending on enemy width there --3 
...
NDefines.NMilitary.ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 80 -- how quickly defense approaches the max impact diminishing returns curve --112
