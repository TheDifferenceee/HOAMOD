...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.18, 0.175, 0.1625, 0.044, 0.0 } --{2.0, 0.5, 0.2, 0.1, 0.0}
...
NDefines.NMilitary.PLANNING_MAX = 0.017                              -- can get more from techs --0.3 vanilla planningi, sistem biraz garip
...
NDefines.NMilitary.UNIT_DIGIN_CAP = 2.0 -- vanilla 5,                           -- how "deep" you can dig you can dig in until hitting max bonus
